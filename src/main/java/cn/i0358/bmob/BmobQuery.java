...
public class BmobQuery {
    ...
    public BmobQuery perpage(int perPageNum) {
        this.limit = perPageNum;
        return this;
    }

    public BmobQuery page(int pageNum, int perPageNum) {
        if (perPageNum >= 1000) {
            perPageNum = 1000;
        }
        this.limit = perPageNum;
    ...
    public BmobQuery page(int pageNum) {
        return this.page(pageNum, this.limit);
    }
    ...
    public Map<String, String> toQueryMap() {
        ...
        mapquery.put("limit", this.limit.toString());
        mapquery.put("skip", this.skip.toString());
